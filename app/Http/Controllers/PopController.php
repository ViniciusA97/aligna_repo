...
class PopController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $response = new \Illuminate\Http\Response(view('pop.index',$data_view));
        $response->withCookie(cookie('cookieName' , 'cookieValue' , 10000));
        return $response;
    }
    ...
    public function create()
    {
        ...
        return view('pop.create', $data_view);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            return back()->with('success', 'POP editado com sucesso!');
        } catch(\Exception $e) {
            return back()->with('action_error', 'Algo saiu errado. Por favor tente novamente!');
        }
    }
    ...
    public function version(Request $request, $id)
    {
        ...
        if(!$version){
            return redirect('pops')->with('action_error', 'Versão do POP não encontrada!');
        }
        ...
        try{
            ...
            return response()->json('Versão alterada com sucesso!', 200);
        } catch(\Exception $e) {
    ...
    public function duplicate($id)
    {
        try{
            ...
            return redirect('/pops')->with('success', 'POP duplicado com sucesso!');
        } catch(\Exception $e) {
            return redirect('/pops')->with('action_error', 'Algo saiu errado ao criar o POP. Por favor tente novamente!');
        }
    }
}
